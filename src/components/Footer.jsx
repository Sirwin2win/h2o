...
const Footer = () => {
  ...
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-2">
          <li><Link to={'/'} className="text-white hover:text-white transition">Home</Link></li>
          <li><Link to={'/about'} className="text-white hover:text-white transition">About Us</Link></li>
          <li><Link to={'/contact'} className="text-white hover:text-white transition">Contact Us</Link></li>
          <li><Link to={'/product'} className="text-white hover:text-white transition">Products</Link></li>
          {/* <li><a href="#" className="text-white hover:text-white transition">Pricing</a></li>
      ...
      <div className="space-y-4">
        {/* <h3 className="text-lg font-semibold">Contact Us</h3> */}
        <address className="not-italic text-white mt-10">
          <p>Shop DLS 35b & 54/5a Dubai-</p>
          <p>Abuja international trade</p>
          <p>center, behind games village,</p>
          <p>Kaura district, Abuja.</p>
          <p>07039254820</p>
    ...
    <div className="border-t border-white pt-6 flex flex-col md:flex-row justify-between items-center">
      <p className="text-white text-sm mb-4 md:mb-0">Copyright  &copy; {year} Buywater. All rights reserved.</p>
      <div className="flex space-x-6">
        <a href="#" className="text-white hover:text-white text-sm transition">Privacy Policy</a>
        <a href="#" className="text-white hover:text-white text-sm transition">Terms of Service</a>
        <a href="#" className="text-white hover:text-white text-sm transition">Cookies</a>
      </div>
    </div>
  </div>
</footer>
