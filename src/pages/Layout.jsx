      ...
      <header className="shadow-md bg-white tracking-wide relative z-50">
            <section
              ...
              <div className="lg:absolute lg:right-10 flex items-center ml-auto space-x-8">
                <Link to={'/sidebar'}>
               <CiSettings className="size-8 text-blue-700" />
               </Link>
              <Link to={'/cart'}>
                <span className="relative">
                  ...
                  <span className="absolute left-auto -ml-1 top-0 rounded-full bg-blue-600 px-1 py-0 text-xs min-w-[15px] text-center text-white">{Math.round(totalQuantity*100)/100}</span>
                </span>
              </Link>
              <Link to={'/login'}>
