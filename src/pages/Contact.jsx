...
<section className="bg-gray-100 py-12">
  <div className="container mx-auto px-4">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-gray-400">
            ...
            option below and we will be happy to to attend to you and give you a good experience.
        </p>
    </div>
    <div
        ...
        <div>
            ...
            <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                ...
                <a href="mailto:hello@company.com">sales@buywaterh2o.com</a>
            </div>
            <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                    stroke="currentColor" aria-hidden="true" className="w-4 h-4">
                ...
                <a href="tel:11111111111">+234 812 414 9531</a>
            </div>
        </div>
        <div>
            <form>
                ...
                <button type="submit"
                    className="w-full py-4 font-semibold text-white transition-colors bg-blue-700 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7 dark:bg-white dark:text-black ">Send
                    Message
                </button>
            </form>
        </div>
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3939.053271586641!2d7.326729773753989!3d9.149661687091092!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104dd8c4da1a32e3%3A0x198512ce8a721b2d!2sBevick%20Integrated%20Technology!5e0!3m2!1sen!2sng!4v1758165639171!5m2!1sen!2sng" width="100%" height="450" style={{border:'0'}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
